                    ...
                    <section class="content">
                        <div class="row">
                            ...
                            {{-- <div class="col-12">
                                <div class="box">
                                    <div class="box-header">
                                        <h4 class="box-title">اطلاعات</h4>
                                        <ul class="box-controls pull-right">
                                            <li class="dropdown">
                                                <a data-bs-toggle="dropdown" href="#"
                                                    class="px-10 hover-primary"><i
                                                        class="ti-menu hover-primary"></i></a><!-https: //t.me/sabzrea
                                                    ->
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="#"><i
                                                                class="ti-import"></i>دریافت</a>
                                                        <a class="dropdown-item" href="#"><i
                                                                class="ti-export"></i>اکسپورت</a>
                                                        <a class="dropdown-item" href="#"><i
                                                                class="ti-printer"></i>پرینت</a>
                                                        <div class="dropdown-divider"></div>
                                                        <a class="dropdown-item" href="#"><i
                                    ...
                                    <div class="box-body">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="d-flex">
                                                    <div class="radio me-25">
                                                        ...
                                                        <label for="radio1">اجاره</label>
                                                    </div>
                                                    <div class="radio">
                                                        <input type="radio" name="radio1" id="radio2"
                                                            value="option2">
                                                        <label for="radio2">فروش</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <textarea rows="4" class="form-control no-resize" placeholder="ادرس کامل"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-md-6">
                                                <div class="form-group mb-lg-0">
                                                    <input type="text" class="form-control" placeholder="پله">
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-md-6">
                                                <div class="form-group mb-lg-0">
                                                    <input type="text" class="form-control" placeholder="پارکینگ">
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-md-6">
                                                <div class="form-group mb-0">
                                ...
                                <div class="box">
                                    ...
                                    <div class="box-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-2 col-md-4 col-12">
                                                <div class="form-line mb-lg-0">
                                                    <input type="text" class="form-control" placeholder="پذیرایی">
                                                </div>
                                            </div>
                                            <div class="col-lg-2 col-md-4 col-12">
                                                <div class="form-group mb-lg-0">
                                                    <input type="text" class="form-control" placeholder="هال">
                                                </div>
                                            </div>
                                            <div class="col-lg-2 col-md-4 col-12">
                                                <div class="form-group mb-lg-0">
                            ...
                            <div class="col-12">
                                <div class="box">
                                    <div class="box-header">
                                        <h4 class="box-title">امکانات بیشتر</h4>
                                        <ul class="box-controls pull-right">
                                            <li class="dropdown">
                                                <a data-bs-toggle="dropdown" href="#"
                                                    class="px-10 hover-primary"><i
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="checkbox d-inline-block me-20">
                                                    ...
                                                    <label for="checkbox1">استخر</label>
                                                </div>
                                                <div class="checkbox d-inline-block me-20">
                                                    <input id="checkbox2" type="checkbox">
                                                    <label for="checkbox2">تراس</label>
                                                </div>
                                                <div class="checkbox d-inline-block me-20">
                                                    <input id="checkbox3" type="checkbox" checked="">
                                                    <label for="checkbox3">هوا خوری</label>
                                                </div>
                                                <div class="checkbox d-inline-block me-20">
                                                    <input id="checkbox4" type="checkbox" checked="">
                                                    <label for="checkbox4">اینترنت</label>
                                                </div>
                                                <div class="checkbox d-inline-block me-20">
                                                    <input id="checkbox5" type="checkbox">
                                                    <label for="checkbox5">تلفن</label>
                                                </div>
                                                <div class="checkbox d-inline-block me-20">
                                                    <input id="checkbox6" type="checkbox">
                                                    <label for="checkbox6">تلویزیون</label>
                                                </div>
                                                <div class="checkbox d-inline-block me-20">
                                                    <input id="checkbox7" type="checkbox">
                                                    <label for="checkbox7">کامپیوتر</label>
                                                </div>
                                                <div class="checkbox d-inline-block me-20">
                                                    <input id="checkbox8" type="checkbox" checked="">
                                                    <label for="checkbox8">ظرفشویی</label>
                                                </div>
                                                <div class="checkbox d-inline-block me-20">
                                                    <input id="checkbox9" type="checkbox" checked="">
                                                    <label for="checkbox9">هود اشپزخانه</label>
                                                </div>
                                                <div class="checkbox d-inline-block me-20">
                                                    <input id="checkbox0" type="checkbox">
                                                    <label for="checkbox0">میز</label>
                                                </div>
                                                <div class="checkbox d-inline-block me-20">
                                                    <input id="checkbox11" type="checkbox">
                                                    <label for="checkbox11">نهارخوری</label>
                                                </div>
                                                <div class="checkbox d-inline-block me-20">
                                                    <input id="checkbox12" type="checkbox">
                                                    <label for="checkbox12">بالکن</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row clearfix">
                                            <div class="col-sm-12">
                                                <form action="https://www.fudademo.ir/" id="frmFileUpload"
                                                    class="dropzone mt-15 dz-clickable" method="post">
                                                    <div class="dz-message">
                                                        <div> <i class="mdi mdi-cursor-pointer fs-36"></i> </div>
                                                        <h3>فایل را بکشید و رها کنید.</h3>
                                                        <em>(فایل فقط انتخاب میشود ولی ذخیره <strong>نمیشود</strong>
                                                            اپلود میشود.)</em><!-https: //t.me/sabzrea ->
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                                    ...
                                    <div class="box-footer">
                                        ...
                                        <button type="submit"
                                            class="btn btn-primary waves-effect waves-light"><!-https: //t.me/sabzrea
                                                ->
                                                <i class="ti-save-alt"></i> ارسال
                                        </button>
                                    </div>
                                </div>
                            </div> --}}
                                    ...
                                    <div class="box-body">
                                        <div class="row">
                                            <div class="col-lg-4 col-12">
                                                <img class="img-thumbnail img-fluid" src="{{ $brand->picture_url }}" alt="img">
                                            </div>
