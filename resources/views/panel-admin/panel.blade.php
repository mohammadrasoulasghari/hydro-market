                            ...
                            <ul class="sidebar-menu" data-widget="tree">
                                ...
                                <li class="treeview">
                                    <a href="#">
                                        ...
                                        <span class="pull-right-container">
                                            <i class="fa fa-angle-right pull-right"></i><!-https: //t.me/sabzrea ->
                                        </span>
                                    </a>
                                    <ul class="treeview-menu">
            ...
            <footer class="main-footer">
                <div class="pull-right d-none d-sm-inline-block">
                    <ul
                        ...
                        <!-https: //t.me/sabzrea ->
                            <li class="nav-item">
                                <a class="nav-link" href="javascript:void(0)">پرسش ها</a><!-https: //t.me/sabzrea ->
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#">اپدیت جدید</a><!-https: //t.me/sabzrea ->
                            </li>
                    </ul>
                </div>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="control-sidebar-home-tab">
                            ...
                            <div class="media-list media-list-hover mt-20">
                                ...
                                <div class="media py-10 px-0">
                                    <a class="avatar avatar-lg status-primary" href="#"><!-https: //t.me/sabzrea
                                            ->
                                            <img src="images/avatar/4.jpg" alt="...">
                                    </a>
                                    <div class="media-body">
                                        <p class="fs-16">
                                            <a class="hover-primary" href="#"><strong>حامد</strong></a><!-https:
                                                //t.me/sabzrea ->
                                        </p>
                                        <p>دسته بندی ها را ویرایش کرد</p><!-https: //t.me/sabzrea ->
                                            <span>۴۳ دقیقه پیش</span>
                                    </div>
                                </div>
                                ...
                                <div class="media py-10 px-0">
                                    ...
                                    <div class="media-body">
                                        <p class="fs-16">
                                            <a class="hover-primary" href="#"><strong>سایه رحیمی
                                                </strong></a><!-https: //t.me/sabzrea ->
                                        </p>
                        ...
                        <div class="tab-pane" id="control-sidebar-settings-tab">
                            ...
                            <ul class="todo-list mt-20">
                                ...
                                <li class="py-15 px-5 by-1">
                                    ...
                                    <small class="badge bg-warning"><i class="fa fa-clock-o"></i> ۱ روز
                                        پیش</small><!-https: //t.me/sabzrea ->
                                        <div class="tools">
                                            <i class="fa fa-edit"></i>
                                            <i class="fa fa-trash-o"></i>
